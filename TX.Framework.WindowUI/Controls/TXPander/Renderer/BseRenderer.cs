...
namespace TX.Framework.WindowUI.Controls
{
    ...
    public class BseRenderer : ToolStripProfessionalRenderer
    {
        ...
        /// </summary>
        public BseRenderer()
            : base(new TX.Framework.WindowUI.Controls.ColorTableBlack())
        {
        ...
        /// </summary>
        /// <param name="professionalColorTable">A <see cref="TX.Framework.WindowUI.Controls.ProfessionalColorTable"/> to be used for painting.</param>
        ...
        protected override void OnRenderArrow(ToolStripArrowRenderEventArgs e)
        {
            ...
            {
                ProfessionalColorTable colorTable = ColorTable as TX.Framework.WindowUI.Controls.ProfessionalColorTable;
