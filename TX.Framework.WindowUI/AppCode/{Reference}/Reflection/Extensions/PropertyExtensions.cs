...
namespace System.Reflection
{
    ...
    public static class PropertyExtensions
    {
        ...
        public static List<PropertyInfo> Properties(this Type type, params string[] names)
        {
        ...
        public static List<PropertyInfo> Properties(this Type type, Flags bindingFlags, params string[] names)
        {
            if (type == null || type == Constants.ObjectType)
            {
                return new List<PropertyInfo>(Constants.EmptyPropertyInfoArray);
            }
            ...
            {
                return new List<PropertyInfo>(type.GetProperties(bindingFlags) ?? Constants.EmptyPropertyInfoArray);
            }
        ...
        private static List<PropertyInfo> GetProperties(Type type, Flags bindingFlags)
        {
            bool recurse = bindingFlags.IsNotSet(Flags.DeclaredOnly);
