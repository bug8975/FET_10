...
{
    /// <summary>
    /// 提供一个对<see cref="ILGenerator"/> 类的封装。
    /// </summary>
    ...
    public class EmitHelper
    {
        ...
        /// <summary>
        /// 使用指定的<see cref="System.Reflection.Emit.ILGenerator"/>初始化 <see cref="EmitHelper"/> 类型
        /// </summary>
        ...
        /// <seealso cref="System.Reflection.Emit.ILGenerator.BeginCatchBlock(Type)">ILGenerator.BeginCatchBlock a</seealso>
        ...
        /// 开始一个异常筛选器块.
        /// </summary>
        /// <seealso cref="System.Reflection.Emit.ILGenerator.BeginExceptFilterBlock">ILGenerator.BeginCatchBlock a</seealso>
        ...
        /// 结束异常块。
        /// </summary>
        /// <returns>当前类型 <see cref="EmitHelper"/>的实例。</returns>
        ...
        public EmitHelper Init(LocalBuilder localBuilder)
        {
            ...
            return type.IsValueType && type.IsPrimitive == false ? ldloca(localBuilder).initobj(type) : LoadInitValue(type).stloc(localBuilder);
        }
        ...
        {
            return type == null ? ldnull : ldtoken(type).call(typeof(Type), "GetTypeFromHandle", typeof(RuntimeTypeHandle));
        }
        ...
        {
            Guard.ArgumentNotNull(type, "type");
            return type == typeof(object) ? this : (type.IsValueType ? unbox_any(type) : castclass(type));
        }
        ...
        public void AddMaxStackSize(int size)
        {
            ...
            //
            FieldInfo fi = _ilGenerator.GetType().GetField("m_maxStackSize", BindingFlags.Instance | BindingFlags.NonPublic);
        ...
        {
            return new InvalidOperationException(string.Format("a {1} cannot be found in type {0}", type.FullName, methodName));
        }
