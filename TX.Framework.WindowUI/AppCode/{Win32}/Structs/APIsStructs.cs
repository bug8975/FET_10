...
namespace System.Win32
{
    ...
    public struct NMLISTVIEW
    {
        ...
        public bool NewSelected
        {
            get
            {
                return ((ListViewItemStates)uNewState & ListViewItemStates.SELECTED) == ListViewItemStates.SELECTED;
            }
        }
        public bool OldSelected
        {
            get
            {
                return ((ListViewItemStates)uOldState & ListViewItemStates.SELECTED) == ListViewItemStates.SELECTED;
            }
        }
        public bool NewCheck
        {
            get
            {
                try
                {
                    return uNewState >= 0x1000 ? ((uNewState & (uint)ListViewItemStates.STATEIMAGEMASK) >> 12) - 1 > 0 : false;
                }
                catch
                {
                    return false;
        ...
        public bool OldCheck
        {
            get
            {
                try
                {
                    return uOldState >= 0x1000 ? ((uOldState & (uint)ListViewItemStates.STATEIMAGEMASK) >> 12) - 1 > 0 : false;
                }
                catch
                {
                    return false;
        ...
        public bool NewFocused
        {
            get
            {
                return ((ListViewItemStates)uNewState & ListViewItemStates.FOCUSED) == ListViewItemStates.FOCUSED;
            }
        }
        public bool OldFocused
        {
            get
            {
                return ((ListViewItemStates)uOldState & ListViewItemStates.FOCUSED) == ListViewItemStates.FOCUSED;
            }
        }
        public bool Select
        {
